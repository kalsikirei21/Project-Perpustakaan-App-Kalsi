...
Route::get('/read', [PeminjamanController::class, 'read']);
Route::put('/update-status/{no_peminjaman', [PeminjamanController::class, 'updateStatus']);
Route::delete('/delete/{ni_peminjaman', [PeminjamanController::class, 'delete']);
});
